...
//     setIsLoggedIn(!!token);
//     if (role == "admin") setUserRole(role);
//   }, []);
...
const PostData = ({ onProjectAdded }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert("Failed to upload project. Please check your login.");
    }
  };
  ...
  return (
    <section id="form" className="container py-5">
      <h1 className="text-center mb-5">Enter Project Details</h1>
      <form onSubmit={handleSubmit} className="row g-4">
        ...
        <div className="col-12 col-md-6">
          <label className="form-label fw-bold">Technologies Used</label>
          <input
            type="text"
            className="form-control"
            name="technoUsed"
        ...
        <div className="col-12 col-md-6">
          <label className="form-label fw-bold">Project URL</label>
          <input
            type="url"
            className="form-control"
            name="projectUrl"
